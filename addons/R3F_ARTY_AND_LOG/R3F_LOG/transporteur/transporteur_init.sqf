...
_transporteur addAction [("<img image='client\icons\r3f_loadin.paa' color='#06ef00'/> <t color='#06ef00'>" + STR_R3F_LOG_action_attach_selection + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\transporteur\attach_selection.sqf", nil, 6, true, true, "", "R3F_LOG_objet_addAction == _target && R3F_LOG_action_charger_deplace_valide"];
