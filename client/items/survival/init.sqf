...
[MF_ITEMS_WATER, "Beer", {50 call mf_items_survival_drink}, "Land_BottlePlastic_V2_F","client\icons\water.paa", 5] call mf_inventory_create;
[MF_ITEMS_ENERGY_DRINK, "Vodka Redbull", _energy_drink, "Land_Can_V3_F","client\icons\water.paa", 2] call mf_inventory_create;
