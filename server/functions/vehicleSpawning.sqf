...
#define A3W_TOWN_SPAWNING_METERS_PER_VEHICLE 17 // This defines a fraction of the town's radius for which to spawn a vehicle (ex.: 20 meters per vehicle in town with 100m radius = 5 vehicles in town)
...
_createRandomVehicle =
{
	...
	switch (true) do
	{
		case (_num < 30): { _vehicleType = mediumMilitaryVehicles call BIS_fnc_selectRandom };
