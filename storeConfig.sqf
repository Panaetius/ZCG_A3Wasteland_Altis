...
[
	...
	["Carrier Lite (Green)", "V_PlateCarrier1_rgr", 50, "vest"],
	["Carrier Lite (Black)", "V_PlateCarrier1_blk", 50, "vest"],
	["Carrier Rig (Green)", "V_PlateCarrier3_rgr", 50, "vest"],
	["Carrier GL Rig (Green)", "V_PlateCarrierGL_rgr", 50, "vest"],
	["GA Carrier Lite (Digi)", "V_PlateCarrierIA1_dgtl", 50, "vest"],
	["GA Carrier Rig (Digi)", "V_PlateCarrierIA2_dgtl", 50, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 50, "vest"],
	...
	["Slash Bandolier (Black)", "V_BandollierB_blk", 50, "vest"],
	["Slash Bandolier (Coyote)", "V_BandollierB_cbr", 50, "vest"],
	["Slash Bandolier (Green)", "V_BandollierB_rgr", 50, "vest"],
	["Slash Bandolier (Khaki)", "V_BandollierB_khk", 50, "vest"],
	["Slash Bandolier (Olive)", "V_BandollierB_oli", 50, "vest"],
	["Chest Rig (Khaki)", "V_Chestrig_khk", 50, "vest"],
	["Chest Rig (Green)", "V_Chestrig_rgr", 50, "vest"],
	["Fighter Chestrig (Black)", "V_Chestrig_blk", 50, "vest"],
	["Fighter Chestrig (Olive)", "V_Chestrig_oli", 50, "vest"],
	["Tactical Vest (Black)", "V_TacVest_blk", 50, "vest"],
	["Tactical Vest (Brown)", "V_TacVest_brn", 50, "vest"],
	["Tactical Vest (Camo)", "V_TacVest_camo", 50, "vest"],
	["Tactical Vest (Khaki)", "V_TacVest_khk", 50, "vest"],
	["Tactical Vest (Olive)", "V_TacVest_oli", 50, "vest"],
	["Tactical Vest (Police)", "V_TacVest_blk_POLICE", 50, "vest"],
	["Raven Night Vest", "V_TacVestIR_blk", 50, "vest"]
];
...
[
	...
	["Camo Net Big", "camonetbig", localize "STR_WL_ShopDescriptions_CamoBig", "client\icons\briefcase.paa", 300, 150],
    ["Syphon Hose", "syphonhose", localize "STR_WL_ShopDescriptions_SyphonHose", "client\icons\jerrycan.paa", 200, 100],
    ["Vodka Redbull", "energydrink", localize "STR_WL_ShopDescriptions_Energy_Drink", "client\icons\water.paa", 100, 50],
